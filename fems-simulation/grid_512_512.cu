...
__constant__ int ept = 4;

// declare global constants
const int N = 512;
const dim3 blocks = dim3(4, 4);
...
int main(int argc, char* argv[]) {
    ...
    create_positional_arrays<<<blocks, threads>>>(d_u, d_u1, d_u2);
    ...
    // free up the host memory used by the positional array u
    free(u);
